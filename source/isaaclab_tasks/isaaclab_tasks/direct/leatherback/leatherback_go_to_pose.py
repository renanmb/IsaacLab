...
# from omni.isaac.lab_tasks.rans import GoToPoseCfg, GoToPoseTask, LeatherbackRobot, LeatherbackRobotCfg
from isaaclab_tasks.rans import GoToPoseCfg, GoToPoseTask, LeatherbackRobot, LeatherbackRobotCfg

############################################################################################################
# Antoine's Code
############################################################################################################
@configclass
class LeatherbackGoToPoseEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class LeatherbackGoToPoseEnv(DirectRLEnv):
    ...
    cfg: LeatherbackGoToPoseEnvCfg

    def __init__(self, cfg: LeatherbackGoToPoseEnvCfg, render_mode: str | None = None, **kwargs):
