...
from isaaclab_tasks.rans import GoThroughPosesCfg, GoThroughPosesTask, LeatherbackRobot, LeatherbackRobotCfg
...
@configclass
class LeatherbackGoThroughPosesEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class LeatherbackGoThroughPosesEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: LeatherbackGoThroughPosesEnvCfg
