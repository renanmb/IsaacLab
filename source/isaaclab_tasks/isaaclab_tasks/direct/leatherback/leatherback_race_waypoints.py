...
from omni.isaac.lab_tasks.rans import LeatherbackRobot, LeatherbackRobotCfg, RaceWaypointsCfg, RaceWaypointsTask
...
class LeatherbackRaceWaypointsEnv(DirectRLEnv):
    ...
    def _setup_scene(self):
        ...
        self.task_api = RaceWaypointsTask(self.cfg.task_cfg, task_uid=0, num_envs=self.num_envs, device=self.device)
