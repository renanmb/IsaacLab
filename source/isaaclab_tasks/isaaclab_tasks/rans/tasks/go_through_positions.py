...
from isaaclab_tasks.rans import GoThroughPositionsCfg
...
class GoThroughPositionsTask(TaskCore):
    ...
    def set_initial_conditions(self, env_ids: torch.Tensor) -> None:
        ...
        Returns:
            Tuple[torch.Tensor, torch.Tensor, torch.Tensor]: The initial position, orientation and velocity of the
              robot."""
